...
class CollectionOnlyPlatformCapabilityTests(TestCase):
    ...
    def test_zhilian_default_contact_is_delivery_capability(self):
        self.assertTrue(platform_supports("zhilian", "deliver"))
        self.assertFalse(platform_supports("zhilian", "monitor"))
